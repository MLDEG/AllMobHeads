advancement revoke @s only all_mob_heads:baby/kill_baby_happy_ghast
...
execute if score looting AMHBabyHappyGhast >= random AMHBabyHappyGhast run loot spawn ~ ~ ~ loot all_mob_heads:baby/baby_happy_ghast
